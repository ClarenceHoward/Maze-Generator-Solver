...
public class SmallerDrawMaze extends JFrame{
  ...
  /* ============================= */
  public SmallerDrawMaze(String labFile) {
  /* ============================= */
    ...
    try {
      ...
      setSize((labWidth)*roomSize+10,(labLength)*roomSize+roomSize+off);
      ...
      display.fillRect(0,0,(labWidth-1)*roomSize,(labLength-1)*roomSize);
      display.setColor(rockColor);
      display.drawRect(0,0,(labWidth-1)*roomSize,(labLength-1)*roomSize);
      display.drawRect(1,1,(labWidth-1)*roomSize-2,(labLength-1)*roomSize-2);
      display.drawRect(2,2,(labWidth-1)*roomSize-4,(labLength-1)*roomSize-4);
      display.drawRect(3,3,(labWidth-1)*roomSize-6,(labLength-1)*roomSize-6);
